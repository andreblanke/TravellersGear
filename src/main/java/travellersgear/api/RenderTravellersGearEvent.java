...
/**
 * This event will be fire when a Traveller's Gear item is rendered (when the item returns something for
 * getArmorModel()).
 */
public final class RenderTravellersGearEvent extends RenderPlayerEvent {
